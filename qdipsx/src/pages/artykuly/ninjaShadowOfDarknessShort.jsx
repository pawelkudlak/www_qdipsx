...
import "../../style/pages/ninjaShadowOfDarknessShort.css"
    ...
    return (
        <div className='shortArticle'>
            <div className='logoContainer'>
                <img id='logoNSOD' src={logo} alt={"źródło: https://images.launchbox-app.com/3298b017-6ef5-4844-bcc4-a22e8db5da81.png"} title={"Tak wygląda logo gry"}></img>
            </div>
            <div>
                <div>
