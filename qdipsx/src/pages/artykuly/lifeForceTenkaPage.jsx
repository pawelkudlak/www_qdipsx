...
const LifeForceTenkaPage = () => {
    return (
        <div>
            <div>
                <p lang='pl'>Strzelanka na PlayStation, którą pamiętałem z Dema i zawsze chciałem zagrać w jej pełną wersję. Po jej zakupie po 20-tu latach, stwierdziłem że niepotrzebnie tyle zwlekałem, tak jakby...</p>
                <img src={screen1} alt={"źródło: https://psxdatacenter.com/games/P/L/SLES-00613.html"} title={"Tak wygląda autocelowanie w grze"}></img>
                ...
                <img src={screen2} alt={"źródło: https://psxdatacenter.com/games/P/L/SLES-00613.html"} title={"Widzisz taką przestrzeć zazwyczaj w 10 fps-ach"}></img>
                ...
                <img src={screen3} alt={"źródło: https://psxdatacenter.com/games/P/L/SLES-00613.html"} title={"Jak ten skurczybyk jest tak blisko, to ty jesteś równie blisko śmierci"}></img>
                ...
                <img src={screen4} alt={"źródło: https://psxdatacenter.com/games/P/L/SLES-00613.html"} title={"Mózg rozwinął skrzydła... znaczy kończyny"}></img>
                ...
                <img src={screen5} alt={"źródło: https://psxdatacenter.com/games/P/L/SLES-00613.html"} title={"Mrok i ciemne korytarze to tutaj codzienność"}></img>
                ...
                <img src={screen6} alt={"źródło: https://psxdatacenter.com/games/P/L/SLES-00613.html"} title={"To coś mówi: Taki @#uj"}></img>
